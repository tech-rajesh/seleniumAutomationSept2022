...
public class ListenersDemo extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter.config().setDocumentTitle("Sopra Automation Report"); // Title of report
		htmlReporter.config().setReportName("Sopra Functional Automation Testing Report"); // name of the report
		...
		extent.setSystemInfo("Project Name","Sopra Automation");
