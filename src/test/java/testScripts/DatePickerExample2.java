...
public class DatePickerExample2 {
    ...
    public void testDAtePicker() throws Exception{
        ...
        String dateTime ="12/07/2021 2:00 PM";
    ...
    WebElement nextLink = driver.findElement(By.cssSelector(".k-i-arrow-60-right"));

    //button to click in center of calendar header

    WebElement midLink = driver.findElement(By.cssSelector(".k-nav-fast"));

    //button to move previous month in calendar

    WebElement previousLink = driver.findElement(By.cssSelector(".k-i-arrow-60-left")); 
